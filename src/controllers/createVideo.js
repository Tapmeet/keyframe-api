...
exports.createVideo = async (req, res, next) => {
  ...
  try {
    ...
    if (templateBlock) {
      const blockLength = templateBlock.length;
      ...
      while (i < blockLength) {
        ...
        if (templateBlock[i].sceneId == 1) {
          ...
          async function getcompressedImg1() {
            return await resizeimg1();
          }
          getcompressedImg1();
          console.log("here1");
...
global.videoTemplate4 = async function videoTemplate4(data, req, res) {
  return new Promise((resolve) => {
    ...
    for (var i = 0; i < result2.length; i++) {
      if (i >= 6) {
        //  text1= text1 + result[i] + " \n ";
        text4 = text4 + result2[i] + " ";
      } else {
        text3 = text3 + result2[i] + " ";
      }
    }
    // for (var i = 0; i < result.length; i++) {
    //   if (i == 6) {
