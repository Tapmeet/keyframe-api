...
var fonts = [
  ...
  {
    family: "Teko",
    file: "./src/Assets/fonts/Teko-Regular.ttf",
    lighter: "./src/Assets/fonts/Teko-Light.ttf",
    bold: "./src/Assets/fonts/Teko-Regular.ttf",
  },
  {
    family: "Merriweather",
    file: "./src/Assets/fonts/Merriweather-Regular.ttf",
    lighter: "./src/Assets/fonts/Merriweather-Light.ttf",
    bold: "./src/Assets/fonts/Merriweather-Bold.ttf",
  },
  {
    family: "DM Serif Display",
    file: "./src/Assets/fonts/DMSerifDisplay-Regular.ttf",
    lighter: "./src/Assets/fonts/DMSerifDisplay-Regular.ttf",
    bold: "./src/Assets/fonts/DMSerifDisplay-Regular.ttf",
  },
];
    ...
    if (templateBlock) {
      ...
      while (i < blockLength) {
        ...
        if (templateBlock[i].sceneId == 1) {
          ...
          var result = data.sceneData.textArray[0].text;
          ...
          let result2 = data.sceneData.textArray[1].text;
        ...
        else if (templateBlock[i].sceneId == 56) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image" || data.sceneData.media[0].type == "img") {
            ...
            const imagepentagon = new FFImage({
              path: assetsPath + "pentagon3.png",
              y: 380,
              x: 680
            });
            imagepentagon.addEffect("fadeIn", 0.6, 1.6);
            scene51.addChild(imagepentagon);
            const imageVline = new FFImage({
              path: assetsPath + "brownverticleline.png",
              y: 385,
            });
            imageVline.addAnimate({
              from: { x: -560 },
              to: { x: 7 },
              time: 1.5,
              delay: 0.5,
            ...
            textTwo.setColor(titleColor2);
            textTwo.setFont(selectedfonts2);
            textTwo.addEffect("fadeIn", 1.2, 1.0);
            scene51.addChild(textTwo);
            ...
            text3o.setColor(titleColor3);
            text3o.setFont(selectedfonts3);
            text3o.addEffect("fadeIn", 1.5, 1.0);
            scene51.addChild(text3o);
            ...
            text5.setColor(titleColor5);
            text5.setFont(selectedfonts5);
            text5.addEffect("fadeIn", 1.8, 1.0);
            scene51.addChild(text5);
        ...
        else if (templateBlock[i].sceneId == 57) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image") {
            const scene51 = new FFScene();
            scene51.setBgColor("#0b2d49");

            const imageline = new FFImage({
              path: assetsPath + "whitestrip.png",
              y: 380,
            });
            imageline.addAnimate({
              from: { x: -1560 },
            ...
            const fontSize1 = parseInt(data.sceneData.textArray[0].fontSize) + 40;
            const textOne = new FFText({
              text: content1[0],
              fontSize: fontSize1,
              x: 1430,
        ...
        else if (templateBlock[i].sceneId == 58) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image") {
            ...
            const whitestrip1 = new FFImage({
              path: assetsPath + "whitesrip58.png",
              x: 645,
            });
            whitestrip1.addAnimate({
              from: { y: -1600 },
              to: { y: 540 },
              time: 3,
              delay: 0.1,
            ...
            scene51.addChild(whitestrip1);

            const whitestrip2 = new FFImage({
              path: assetsPath + "whitesrip58.png",
              x: 1270,
            });
            whitestrip2.addAnimate({
              from: { y: 3600 },
              to: { y: 540 },
              time: 3,
              delay: 0.1,
            ...
            textOne2.setColor(titleColor1);
            textOne2.setFont(selectedfonts1);
            textOne2.addEffect("backInDown", 1.5, 1.0);
            scene51.addChild(textOne2);
            ...
            textTwo.setColor(titleColor2);
            textTwo.setFont(selectedfonts2);
            textTwo.addEffect("backInDown", 1.5, 1.0);
            scene51.addChild(textTwo);
            ...
            text3o.setColor(titleColor3);
            text3o.setFont(selectedfonts3);
            text3o.addEffect("backInDown", 1.5, 1.0);
            scene51.addChild(text3o);
        ...
        else if (templateBlock[i].sceneId == 59) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image") {
            ...
            const blackstrip = new FFImage({
              path: assetsPath + "bluckbgtrs.png",
              x: 239,
            });
        ...
        else if (templateBlock[i].sceneId == 60) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image" || data.sceneData.media[0].type == "img") {
            ...
            scene51.addChild(image5);
            const image = new FFImage({
              path: assetsPath + "bgwhitetransparent2.png",
              x: 450,
            });
            image.addAnimate({
              from: { y: -1960 },
            ...
            const image2 = new FFImage({
              path: assetsPath + "icon-coming-soon.png",
              x: 450,
            });
            image2.addAnimate({
              from: { y: -1960 },
        ...
        else if (templateBlock[i].sceneId == 61) {
          let data = templateBlock[i];
        ...
        else if (templateBlock[i].sceneId == 68) {
          let data = templateBlock[i];
          const fourthVideo = await videoTemplate68(data);
          var result = data.sceneData.textArray[0].text.split(" ");
          let fontfamily = data.sceneData.textArray[0].fontFamily;
          let selectedfonts;
          fonts.map(function (font) {
          ...
          if (data.sceneData.media[0].type == "image") {
            ...
            scene51.addChild(image);
            const imagepenta = new FFImage({
              path: assetsPath + "pentagon3.png",
              y: 150,
            });
            imagepenta.addAnimate({
              from: { x: 2600 },
              to: { x: 1870 },
              time: 1.5,
              delay: 0.1,
            ...
            scene51.addChild(image1);
            const image21 = new FFImage({
              path:
                assetsPath +
                "template/videos/" +
                userId +
        ...
        else if (templateBlock[i].sceneId == 70) {
          let data = templateBlock[i];
        ...
        else if (templateBlock[i].sceneId == 71) {
          let data = templateBlock[i];
        ...
        else if (templateBlock[i].sceneId == 72) {
          let data = templateBlock[i];
        ...
        else if (templateBlock[i].sceneId == 73) {
          let data = templateBlock[i];
          const fourthVideo = await videoTemplate73(data);
          let fontfamily = data.sceneData.textArray[0].fontFamily;
          let selectedfonts;
          fonts.map(function (font) {
            if (font.family == fontfamily) {
        ...
        else if (templateBlock[i].sceneId == 74) {
          let data = templateBlock[i];
          ...
          if (data.sceneData.media[0].type == "image") {
            ...
            text1.setFont(selectedfonts4);
            text1.addEffect("fadeIn", 1, 1.3);
            text1.alignCenter();
            ...
            text5.setStyle({
              ...
              fontSize: fontSize5,
              padding: [0, 20, 10, 20],
              lineHeight: fontSize5 + 20,
              color: data.sceneData.textArray[4].fontColor,
            });
            text5.alignCenter();
            text5.setStyle({ padding: [4, 20, 6, 20] });
            text5.setFont(selectedfonts5);
        ...
        else if (templateBlock[i].sceneId == 75) {
          let data = templateBlock[i];
        ...
        else if (templateBlock[i].sceneId == 76) {
          let data = templateBlock[i];
          const fourthVideo = await videoTemplate56(data);
        ...
        else if (templateBlock[i].sceneId == 77) {
          let data = templateBlock[i];
          const fourthVideo = await videoTemplate60(data);
        ...
        else if (templateBlock[i].sceneId == 78) {
          let data = templateBlock[i];
          const fourthVideo = await videoTemplate56(data);
...
global.videoTemplate56 = async function videoTemplate56(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate57 = async function videoTemplate57(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate58 = async function videoTemplate58(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate59 = async function videoTemplate59(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate60 = async function videoTemplate60(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate61 = async function videoTemplate61(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate71 = async function videoTemplate71(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate72 = async function videoTemplate72(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate73 = async function videoTemplate73(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["2"].url)
      .then((img) => {
        img
...
global.videoTemplate74 = async function videoTemplate74(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
...
global.videoTemplate75 = async function videoTemplate75(data, req, res) {
  return new Promise((resolve) => {
    Jimp.read(assetsPath + data.sceneData.media["0"].url)
      .then((img) => {
        img
